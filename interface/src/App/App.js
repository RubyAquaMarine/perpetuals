...
import { ARBITRUM, TELOS_TESTNET, getAlchemyWsUrl, getExplorerUrl } from "config/chains";
...
const avaxWsProvider = new ethers.providers.JsonRpcProvider("https://testnet.telos.net/evm");
    ...
    if (!hasCoinBaseWalletExtension()) {
      helperToast.error(
        <div>
          ...
          {userOnMobileDevice ? (
            <Trans>
              <ExternalLink href="https://www.coinbase.com/wallet">Install Coinbase Wallet</ExternalLink>, and use OmniDex

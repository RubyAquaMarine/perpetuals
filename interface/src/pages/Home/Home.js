...
export default function Home({ showRedirectModal, redirectPopupTimestamp }) {
  ...
  //   answer: "The GLP token represents the liquidity users provide to the GMX platform for Swaps and Margin Trading.<br><br>To provide liquidity to GLP you <a href='https://gmx.io/buy_olp' target='_blank'>trade</a> your crypto asset BTC, ETH, LINK, UNI, USDC, USDT, MIM, or FRAX to the liquidity pool, in exchange, you gain exposure to a diversified index of tokens while earning 50% of the platform trading fees and esGMX."
  // }, {
  //   id: 4,
        ...
        <div className="Home-title-section-container default-container">
          <div className="Home-title-section">
            ...
            <div className="Home-description">
              <Trans>
                Trade with up to 30x leverage, obtain credit through overcollateralised loans and earn interest by providing liquidity.
              </Trans>
            </div>
      ...
      {/* <div className="Home-faqs-section">
        <div className="Home-faqs-container default-container">
          <div className="Home-faqs-introduction">
            ...
            <a href="https://docs.omnidex.finance/" className="default-btn Home-faqs-documentation">Documentation</a>
          </div>

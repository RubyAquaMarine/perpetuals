...
import avaIcon from "img/ic_tlos_96.svg";
  ...
  return (
    <div className="ClaimEsGmx Page page-layout">
      <div className="Page-title-section mt-0">
        ...
        */}
                <div className="ClaimEsGmx-option-label">
                  <Trans>Vest with CHARM on Telos</Trans>
                </div>
              ...
              >
                <div className="ClaimEsGmx-option-label avalanche">
                  <Trans>Vest with OLP on Telos</Trans>
                </div>
                <img src={avaIcon} alt="Avalanche" />
              </Checkbox>
            </div>
            ...
            {!error && (
              <div className="muted">
                <Trans>
                  You can currently vest a maximum of {formatAmount(maxVestableAmount, 18, 2, true)} esCHARM tokens at a
                  ratio of {formatAmount(currentRatio, 4, 2, true)} {stakingToken} to 1 esCHARM.
                </Trans>
                ...
                <Trans>
                  ...
                  esGMX at a ratio of {formatAmount(nextRatio, 4, 2, true)} {stakingToken} to 1 esCHARM.
                </Trans>

...
export default function BeginAccountTransfer(props) {
  ...
  const getError = () => {
    ...
    if (hasVestedGmx) {
      return t`Vested CHARM not withdrawn`;
    }
    if (hasVestedGlp) {
      ...
      <div className="Page-title-section">
        ...
        <div className="Page-description">
          <Trans>
            ...
            <br />
            This will transfer all your CHARM, esCHARM, OLP and Multiplier Points to your new account.
            <br />
            Transfers are only supported if the receiving account has not staked CHARM or OLP tokens before.
            <br />
        ...
        <div className="input-form">
          ...
          <div className="BeginAccountTransfer-validations">
            <ValidationRow isValid={!hasVestedGmx}>
              <Trans>Sender has withdrawn all tokens from CHARM Vesting Vault</Trans>
            </ValidationRow>
            ...
            <ValidationRow isValid={!hasStakedGmx}>
              <Trans>Receiver has not staked CHARM tokens before</Trans>
            </ValidationRow>

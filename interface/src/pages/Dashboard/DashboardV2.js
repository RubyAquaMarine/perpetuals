...
import avalanche16Icon from "img/ic_tlos_16.svg";
import arbitrum16Icon from "img/ic_arbitrum_16.svg";
import arbitrum24Icon from "img/ic_arbitrum_24.svg";
import avalanche24Icon from "img/ic_tlos_24.svg";
...
import { ARBITRUM, TELOS_TESTNET, getChainName } from "config/chains";
...
export default function DashboardV2() {
  ...
  const { infoTokens: infoTokensArbitrum } = useInfoTokens(null, TELOS_TESTNET, active, undefined, undefined);
  const { infoTokens: infoTokensAvax } = useInfoTokens(null, TELOS_TESTNET, active, undefined, undefined);
  ...
  const { gmxPrice, gmxPriceFromArbitrum, gmxPriceFromAvalanche } = useGmxPrice(
    chainId,
    { arbitrum: chainId === TELOS_TESTNET ? library : undefined }, // Changed from ARBITRUM -> TELOS
    active
  );
        ...
        renderContent={() => {
          return (
            <>
              ...
              <br />
              <div>
                <ExternalLink href="https://docs.omnidex.finance/">
  ...
  const totalStatsStartDate = chainId === TELOS_TESTNET ? t`06 Jan 2022` : t`01 Sep 2021`;
      ...
      <div className="default-container DashboardV2 page-layout">
        <div className="section-title-block">
          ...
          <div className="section-title-content">
            <div className="Page-title">
              <Trans>Stats</Trans> {chainId === TELOS_TESTNET && <img src={avalanche24Icon} alt="avalanche24Icon" />}
            ...
            <div className="Page-description">
              ...
              {chainId === ARBITRUM && <ExternalLink href="https://stats.omnidex.finance">https://stats.omnidex.finance</ExternalLink>}
              {chainId === TELOS_TESTNET && (
                <ExternalLink href="https://stats.omnidex.finance/telos">https://stats.omnidex.finance/telos</ExternalLink>
              )}
              .
            </div>
          </div>
        ...
        <div className="DashboardV2-content">
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    <TooltipComponent
                      ...
                      position="right-bottom"
                      renderContent={() => (
                        <span>{t`Assets Under Management: CHARM staked (All chains) + OLP pool (${chainName}).`}</span>
                      )}
                    />
                  </div>
                </div>
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          avaxValue={currentVolumeInfo?.[TELOS_TESTNET].totalVolume}
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          avaxValue={positionStatsInfo?.[TELOS_TESTNET].totalLongPositionSizes}
                          total={positionStatsInfo?.[TELOS_TESTNET].totalLongPositionSizes} // {positionStatsInfo?.totalLongPositionSizes}
                        />
                      )}
                    />
                  </div>
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          avaxValue={positionStatsInfo?.[TELOS_TESTNET].totalShortPositionSizes}
                      ...
                      <TooltipComponent
                        ...
                        renderContent={() => (
                          <StatsTooltip
                            ...
                            avaxValue={currentFees?.[TELOS_TESTNET]}
                            total={currentFees?.[TELOS_TESTNET]} // {currentFees?.total}
                          />
                        )}
                      />
                    </div>
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          avaxValue={totalFees?.[TELOS_TESTNET]}
                          total={totalFees?.[TELOS_TESTNET]} // {totalFees?.total}
                    ...
                    <TooltipComponent
                      ...
                      renderContent={() => (
                        <StatsTooltip
                          ...
                          avaxValue={totalVolume?.[TELOS_TESTNET]}
                          total={totalVolume?.[TELOS_TESTNET]} // {totalVolume?.total}
                        />
                      )}
                    />
                  </div>
          ...
          <div className="Tab-title-section">
            <div className="Page-title">
              <Trans>Tokens</Trans> {chainId === TELOS_TESTNET && <img src={avalanche24Icon} alt="avalanche24Icon" />}
              {chainId === ARBITRUM && <img src={arbitrum24Icon} alt="arbitrum24Icon" />}
            </div>
            <div className="Page-description">
          ...
          <div className="DashboardV2-token-cards">
                ...
                <div className="stats-block">
                  <div className="App-card-title">
                    <div className="App-card-title-mark">
                      ...
                      <div className="App-card-title-mark-info">
                        <div className="App-card-title-mark-title">CHARM</div>
                        <div className="App-card-title-mark-subtitle">CHARM</div>
                      </div>
                      <div>
                        <AssetDropdown assetSymbol="CHARM" />
                      </div>
                    </div>
                  </div>
                  <div className="App-card-divider"></div>
                  <div className="App-card-content">
                    ...
                    <div className="App-card-row">
                      ...
                      <div>{formatAmount(totalGmxSupply, GMX_DECIMALS, 0, true)} CHARM</div>
                    </div>
                    <div className="App-card-row">
                      <div className="label">
            ...
            <div className="token-table-wrapper App-card">
              <div className="App-card-title">
                ...
                {chainId === TELOS_TESTNET && <img src={avalanche16Icon} alt={t`Avalanche Icon`} />}

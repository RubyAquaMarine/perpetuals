          ...
          <div className="content">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                <ExternalLink href="https://docs.omnidex.finance/referrals">
                  https://docs.omnidex.finance/referrals.
                </ExternalLink>
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                https://perpetuals.omnidex.finance/referral-terms. All modifications will be effective when they are posted. By using the

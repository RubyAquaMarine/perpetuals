...
export function RedirectPopupModal({
  ...
  return (
    <Modal
      ...
      label={t`Launch App`}
    >
      <Trans>You are leaving OmniDex.finance and will be redirected to a third party, independent website.</Trans>
      <br />
      <br />
      <Trans>
        The website is a community deployed and maintained instance of the open source{" "}
        <ExternalLink href="https://github.com/OmniDexFinance/gmx-interface">OmniDex front end</ExternalLink>, hosted and served on
      ...
      <Trans>
        ...
        <ExternalLink href="https://docs.omnidex.finance/app-links">docs</ExternalLink>.
        <br />
        <br />
        By clicking Agree you accept the <ExternalLink href="https://perpetauls.omnidex.finance/#/terms-and-conditions">
          T&Cs
        </ExternalLink>{" "}
        and <ExternalLink href="https://perpetuals.omnidex.finance/#/referral-terms">Referral T&Cs</ExternalLink>.
        <br />
        <br />
      </Trans>
      <div className="mb-sm">

...
import { ARBITRUM, ARBITRUM_TESTNET, TELOS_TESTNET, getChainIcon, getChainName } from "config/chains";
...
*/
  {
    label: getChainName(TELOS_TESTNET),
    value: TELOS_TESTNET,
    icon: getChainIcon(TELOS_TESTNET, 24),
    color: "#E841424D",
  },
];

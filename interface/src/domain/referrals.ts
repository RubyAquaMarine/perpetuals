...
import { arbitrumReferralsGraphClient, avalancheReferralsGraphClient, telosTestnetReferralsGraphClient } from "lib/subgraph/clients";
...
const ACTIVE_CHAINS = [ARBITRUM, AVALANCHE, TELOS_TESTNET];
...
function getGraphClient(chainId) {
  if (chainId === ARBITRUM) {
    ...
    return telosTestnetReferralsGraphClient;
  }

...
export const homeEventsData: EventData[] = [
  ...
  //     {
  //       text: "Learn More",
  //       link: "https://medium.com/@Omni-Dex/sign-up-for-the-gmxrush-avalanche-trading-contest-win-100-000-usd-in-prizes-546b1ab2e416",
  //       newTab: true,
  //     },
  //   ],
  // },
  ...
  //     {
  //       text: "Read More",
  //       link: "https://medium.com/@Omni-Dex/gmx-frontend-updates-8d13f2346e1e",
  //       newTab: true,
  //     },
  //   ],
  // },
  ...
  //     {
  //       text: "Read More",
  //       link: "https://medium.com/@Omni-Dex/arbitrum-nitro-5f88c03a46fe",
  //       newTab: true,
  //     },
  //   ],
  // },
...
export const appEventsData: EventData[] = [
  ...
  //     {
  //       text: "Read more",
  //       link: "https://docs.omnidex.finance/roadmap#30-march-2022",
  //       newTab: true,
  //     },
  //     {
  //       text: "Trade Now",
  ...
  //     {
  //       text: "Learn More",
  //       link: "https://docs.omnidex.finance/trading#backup-rpc-urls",
  //       newTab: true,
  //     },
  //   ],
  // },
  ...
  //     {
  //       text: "Read More",
  //       link: "https://medium.com/@Omni-Dex/gmx-arbitrum-odyssey-fc12cba2d10d",
  //     },
  //   ],
  // },
  // {
  ...
  //     {
  //       text: "Read More",
  //       link: "https://twitter.com/OmniDex1/status/1542163585111150592",
  //       newTab: true,
  //     },
  //   ],
  // },
  ...
  //     {
  //       text: "Read More",
  //       link: "https://medium.com/@Omni-Dex/gmx-deployment-updates-a6a470df445f",
  //       newTab: true,
  //     },
  //   ],
  // },
  {
    ...
    buttons: [
      {
        text: "Read More",
        link: "https://medium.com/@Omni-Dex/gmx-deployment-updates-nov-2022-16572314874d",
        newTab: true,
      },
    ],
  },

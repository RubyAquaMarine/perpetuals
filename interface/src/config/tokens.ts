...
import { ARBITRUM, ARBITRUM_TESTNET, AVALANCHE, AVALANCHE_FUJI, MAINNET, TESTNET, TELOS_TESTNET } from "./chains";
...
export const ADDITIONAL_TOKENS: { [chainId: number]: Token[] } = {
  [ARBITRUM]: [
    ...
    },
    {
      ...
      decimals: 18,
      imageUrl: "https://github.com/OmniDexFinance/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
    },
  ],
  [AVALANCHE]: [
    {
  ...
  [TELOS_TESTNET]: [
    {
      name: "GMX",
      symbol: "GMX",
      address: getContract(TELOS_TESTNET, "GMX"),
      decimals: 18,
      imageUrl: "https://assets.coingecko.com/coins/images/18323/small/arbit.png?1631532468",
    },
    {
      name: "Escrowed GMX",
      symbol: "esGMX",
      address: getContract(TELOS_TESTNET, "ES_GMX"),
      decimals: 18,
    },
    {
      name: "GMX LP",
      symbol: "GLP",
      address: getContract(TELOS_TESTNET, "GLP"),
      decimals: 18,
      imageUrl: "https://github.com/OmniDexFinance/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
    },
  ],
...
export const PLATFORM_TOKENS: { [chainId: number]: { [symbol: string]: Token } } = {
  ...
  [TELOS_TESTNET]: {
    ...
    GLP: {
      ...
      symbol: "GLP",
      decimals: 18,
      address: getContract(TELOS_TESTNET, "StakedGlpTracker"), // address of fsGLP token because user only holds fsGLP
      imageUrl: "https://github.com/OmniDexFinance/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
    },
  },
  [AVALANCHE]: {
...
const CHAIN_IDS = [MAINNET, TESTNET, ARBITRUM, ARBITRUM_TESTNET, AVALANCHE, AVALANCHE_FUJI, TELOS_TESTNET];
